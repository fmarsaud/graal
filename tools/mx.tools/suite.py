suite = {
    ...
    "libraries": {
       ...
       "NanoHTTPD-WebSocket" : {
        ...
        "VISUALVM_COMMON" : {
            "urls" : ["http://graal.us.oracle.com/slavefiles/visualvm/visualvm-592.tar.gz"],
        ...
        "VISUALVM_PLATFORM_SPECIFIC" : {
            "os_arch" : {
                "linux" : {
                    "amd64" : {
                        "urls" : ["http://graal.us.oracle.com/slavefiles/visualvm/visualvm-592-linux-amd64.tar.gz"],
                        "sha1" : "725aeb7cdf1ed8c5272b2b4efd57101102676676",
                    }
                },
                "darwin" : {
                    "amd64" : {
                        "urls" : ["http://graal.us.oracle.com/slavefiles/visualvm/visualvm-592-macosx-x86_64.tar.gz"],
